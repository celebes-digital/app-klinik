            ...
            <div @click.away="clear()">
                ...
                <div x-cloak class="relative" x-show="focused">
                    ...
                    >
                        ...
                        >
                            @foreach ($tindakanOptions as $item)
                                <div 
                                    ...
                                    <div class="flex items-center gap-2">
                                        ...
                                        @if (in_array($item->kode_tindakan, array_column($selectedOption, 'kode_tindakan')))
                                            <x-button
                                            ...
                                            @else
                                            <x-button
                                                wire:click="addDiagnosis('{{$item->kode_tindakan}}')" 
                                                icon-right="o-arrow-right-circle" 
                                                class="btn-primary btn-sm" 
                                                spinner="addDiagnosis('{{$item->kode_tindakan}}')"
                                            />
                                        @endif
                                    </div>
                                </div>
                ...
                @else
                    ...
                    <div class="mt-2 space-y-2">
                        <div class="flex items-center justify-between">
                            <div class="font-semibold text-gray-400">Total Harga</div>
                            <div class="font-semibold">{{$total_harga}}</div>
                        </div>
                        <x-button
                            label="Simpan"
                            class="btn-primary"
